...
namespace ManageSharepoint.Website
{
    public class SharepointWebsiteTool
    {
        ...
        private static void GetPropertiesSharepointSite(ClientContext context)
        {
        ...
        private static void SetPropertiesSharepointSite(ClientContext context)
        {
            ConsoleColor defaultForeground = Console.ForegroundColor;
            string title = GetInput("Give the new title", false, defaultForeground);
            string description = GetInput("Give the new description", false, defaultForeground);
            // The SharePoint web at the URL.
            Web web = context.Web;
        ...
        private static void CreateNewSharePointWebsite(ClientContext context)
        {
            ConsoleColor defaultForeground = Console.ForegroundColor;
            string title = GetInput("Give the new title for the new", false, defaultForeground);
            string description = GetInput("Give the new description for the new", false, defaultForeground);
